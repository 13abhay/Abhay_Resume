...
\cvnumberphone{+91 8826403904} % Phone number
...
\skills{{Shell Scripting(Bash)/4.5},{MATLAB/3},{Java/3},{Python/5},{C,C++/5}}
...
\iskills{{Basics of Ethical Hacking \& Pentesting/2.5},{Robotics/4.5},{Web Development/4.5},{Deep Learning/4},{Machine Learning/4.5}}

\oskills{{ROS/2.5},{LaTeX/3.5},{Cognitive Sciences \& Brain Psychology/2.5},{fMRI/4.5},{EEG/4.5}}
%----------------------------------------------------------------------------------------
...
\begin{twentyshort} % Environment for a short list with no descriptions
	\twentyitemshort{August 2018}{Co-Author for paper on Reconfiguration of Resting State Networks and resting EEG Microstates sent to 5th Annual Conference of Association for Cognitive Sciences(Accepted).}
	\twentyitemshort{March 2018}{3rd position holder (National) in E-yantra Robotics Competition(IIT BOMBAY)
