...
\usepackage[left=0.75in,top=0.6in,right=0.75in,bottom=0.2in]{geometry} % Document margins
...
%\item \textbullet \ Made a Fighting Robot with roller embedded with blades as weapon(team of 4)(2016).
%\item \textbullet \ Made an E-commerce Website and Railway Reservation System(Web)(2016).
%\end{rSection}
